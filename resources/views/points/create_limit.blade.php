<form id="modalForm" action="{{ admin_route_url('task.limit.store') }}"  method="POST">
    {{ csrf_field() }}
    <div class="modal-header">
        <a class="close btn-modal-close" data-dismiss="modal">&times;</a>
        <h4><i class="fa fa-tasks fa-btn"></i> <span class="action-title">Add </span> Limit</h4>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="form-group col-sm-2" style="margin-right: 0px;">
                        ...
                        <input type="text" class="form-control input-sm" name="limit_daily" placeholder="Limit" required="required">
                    </div>

                    <div class="form-group col-sm-2">
                        <label for="weekly">Weekly</label>
                        <input type="text" class="form-control input-sm" name="limit_weekly" placeholder="Limit" required="required">
                    </div>
                </div>
