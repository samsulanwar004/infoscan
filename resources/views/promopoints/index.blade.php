...
@section('content')
    @include('partials.content_header', ['pageTitle' => 'Promo Point', 'pageDescription' => 'Promo Point Manager', 'breadcrumbs' => ['Points' => false]])
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    @cando('Points.Create')
                    <a href="{{ admin_route_url('promo-points.create') }}" class="btn btn-box-tool"
                        data-toggle="modal"
                        data-target="#"
                        modal-size="modal-lg"
                        title="Create New">
