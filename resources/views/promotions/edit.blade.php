                ...
                <form role="form" action="{{ admin_route_url('promotions.update', ['id' => $promotion->id]) }}"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category" required="required">
                                ...
                                @foreach($categories as $category)
                                    <option @if($promotion->product_category_id == $category->id) selected @endif value="{{ $category->id }}">{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="point" class="form-control" value="{{ old('point', $promotion->point) }}" placeholder="Enter Point">
                        </div>
