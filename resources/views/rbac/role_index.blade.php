        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{ admin_route_url('roles.create') }}" class="btn btn-box-tool" data-toggle="tooltip"
                       title="Create New">
                ...
                <table class="table table-striped">
                    ...
                    @forelse($roles as $role)
                        <tr>
                            ...
                            <td class="vertical-middle">
                                <a href="{{ admin_route_url('roles.show', ['id' => $role->id]) }}"
                                   data-toggle="modal"
                                   data-target="#"
                                >
                            ...
                            <td class="text-right vertival-middle">
                                <div class="btn-group">
                                    <a href="{{ admin_route_url('roles.edit', ['id' => $role->id]) }}" class="btn btn-info">
                                        <i class="fa fa-pencil"> </i>
                                    </a>
                                    <a class="btn btn-danger"
                                       href="{{ admin_route_url('roles.destroy', ['id' => $role->id]) }}"
                                       data-toggle="modal"
                                       data-target="#"
